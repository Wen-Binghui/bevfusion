...
class VectorizeLocalMap(object):
    ...
    def __init__(self,
        ...
        self.map_explorer: Dict[str, CNuScenesMapExplorer] = {}
    ...
    def get_global_patch(self, input_dict: dict):
        ...
        patch_box = (map_pose[0], map_pose[1], 
                     self.patch_size[0], self.patch_size[1]) # loc & size of patch
        patch_angle = quaternion_yaw(rotation) / np.pi * 180 # in degree
